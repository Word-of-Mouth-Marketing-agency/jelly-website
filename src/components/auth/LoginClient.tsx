      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e8e2cf]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              <label htmlFor="login-email" className="block text-sm font-semibold text-[#4a4732] mb-1.5">
                Email
              </label>
              <input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-semibold text-[#4a4732] mb-1.5">
                Password
              </label>
              <input
                id="login-password"
            ...
            {error && (
              <p id="login-error" role="alert" className="text-sm text-[#ba1a1a] bg-[#ffdad6] rounded-lg px-4 py-2.5">
                {error}
              </p>
            )}
